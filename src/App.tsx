...
const HOW_IT_WORKS_STEPS = [
  {
    title: 'Lee tu entrada del día',
    text: 'Una historia real, un versículo en su contexto y una reflexión corta. 5 minutos, cada mañana.',
  },
  {
    title: 'Responde al reto de hoy',
    text: 'Un paso pequeño y concreto: "cuando [algo cotidiano], entonces [una acción de fe]". Nada de propósitos vagos.',
  },
  {
    title: 'Cierra con una oración guiada',
    text: 'Completa el espacio en blanco con tu propia palabra y termina el día habiendo hablado con Dios de verdad.',
  },
]
      ...
      <div style={{ position: 'absolute', top: '310vh', left: 0, right: 0, textAlign: 'center', padding: '0 24px', zIndex: 1 }}>
        <div style={{ maxWidth: '640px', margin: '0 auto' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-serif)', color: '#f5f0e8', fontSize: 'clamp(24px, 4vw, 38px)', fontWeight: 700, lineHeight: 1.2, marginBottom: '40px' }}>
            Tres pasos para volver, cada día
          </h2>
